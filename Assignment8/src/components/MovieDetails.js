...
const movies=[
  { id: 1, title: 'The Conjuring', imgSrc: image1, description: 'Description of cojuring:-----"The conjuring" is a popular  movie that follows the real-life experiences of paranormal investigators Ed and Lorraine Warren. In the film, they help a family terrorized by a dark presence in their farmhouse. The movie is known for its intense atmosphere, creepy moments, and jump scares. It is definitely a spine-chilling watch for horror fans!' },
  { id: 2, title: 'kohram', imgSrc: image2, description: 'Description of movie kohram:----"The movie kohram" is a biographical sports drama film based on the life of Indian former cricketer and captain of the Indian cricket team, Major Rajesh Singh. It showcases his journey, struggles, and achievements in the world of cricket. The film highlights his determination, passion for the sport, and the challenges he overcame to become a successful cricketer. It is an inspiring and emotional story that resonates with audiences.'},
